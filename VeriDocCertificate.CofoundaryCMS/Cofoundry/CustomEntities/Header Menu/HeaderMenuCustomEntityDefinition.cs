...
/// </summary>
public class HeaderMenuCustomEntityDefinition : ICustomEntityDefinition<HeaderMenuDataModel>
{
    /// <summary>
    ...
    /// </summary>
    public const string DefinitionCode = "HEMENU";
    ...
    /// </summary>
    public string Name => "Page Link";

    /// <summary>
    /// Plural name of the entity
    /// </summary>
    public string NamePlural => "Page Links";
