...
/// </summary>
public class CustomSchemaEntityDefinition : ICustomEntityDefinition<CustomSchemaDataModel>
{
    /// <summary>
    ...
    /// </summary>
    public const string DefinitionCode = "XSCHMA";
    ...
    /// </summary>
    public string Name => "Custom Schema";

    /// <summary>
    /// Plural name of the entity
    /// </summary>
    public string NamePlural => "Custom Schemas";

    /// <summary>
    /// A short description that shows up as a tooltip for the admin 
    /// module.
    /// </summary>
    public string Description => "Used to manage header menu.";
