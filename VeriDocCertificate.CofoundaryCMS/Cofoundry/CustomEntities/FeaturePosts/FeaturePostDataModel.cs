...
/// </summary>
public class FeaturePostDataModel : ICustomEntityDataModel
{
    [Number]
    [Required]
    ...
    [Document]
    [Display(Name = "Icon Image", Description = "Square image that displays against the feature in the listing page.")]
    public int? ThumbnailIconId { get; set; }
    ...
    [MaxLength(1)]
    [Required]
    [Display(Name = "Feature Categories", Description = "Drag and drop to customize the category ordering.")]
    [CustomEntityCollection(FeatureCategoryCustomEntityDefinition.DefinitionCode, IsOrderable = true)]
