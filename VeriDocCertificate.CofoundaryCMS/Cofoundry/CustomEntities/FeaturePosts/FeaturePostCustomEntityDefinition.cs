...
/// </summary>
public class FeaturePostCustomEntityDefinition
    : ICustomEntityDefinition<FeaturePostDataModel>
    , ISortedCustomEntityDefinition
{
    ...
    /// </summary>
    public const string DefinitionCode = "SIMNLP";
    ...
    /// </summary>
    public string Name => "Feature Post";

    /// <summary>
    /// Plural name of the entity.
    /// </summary>
    public string NamePlural => "Feature Posts";

    /// <summary>
    /// A short description that shows up as a tooltip for the admin .
    /// module.
    /// </summary>
    public string Description => "Articles that appear in the Feature section of the site.";
