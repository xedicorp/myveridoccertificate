...
/// </summary>
public class FaqPostDisplayModelMapper
    : ICustomEntityDisplayModelMapper<FaqPostDataModel, FaqPostDisplayModel>
{
    private readonly IContentRepository _contentRepository;

    public FaqPostDisplayModelMapper(
    ...
    /// </param>
    public async Task<FaqPostDisplayModel> MapDisplayModelAsync(
        CustomEntityRenderDetails renderDetails,
        FaqPostDataModel dataModel,
        PublishStatusQuery publishStatusQuery
        )
    {
        var displayModel = new FaqPostDisplayModel()
        {
