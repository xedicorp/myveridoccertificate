...
/// </summary>
public class FaqPostCustomEntityDefinition
    : ICustomEntityDefinition<FaqPostDataModel>
    , ISortedCustomEntityDefinition
{
    ...
    /// </summary>
    public const string DefinitionCode = "SIMFLP";
    ...
    /// </summary>
    public string Name => "Faq Post";

    /// <summary>
    /// Plural name of the entity.
    /// </summary>
    public string NamePlural => "Faq Posts";

    /// <summary>
    /// A short description that shows up as a tooltip for the admin .
    /// module.
    /// </summary>
    public string Description => "Articles that appear in the Faq section of the site.";
