...
/// </summary>
public class FeatureCategoryCustomEntityDefinition : ICustomEntityDefinition<FeatureCategoryDataModel>
{
    /// <summary>
    ...
    /// </summary>
    public const string DefinitionCode = "SIMFAT";
    ...
    /// </summary>
    public string Name => "Feature Category";

    /// <summary>
    /// Plural name of the entity
    /// </summary>
    public string NamePlural => "Feature Categories";
