...
/// </summary>
public class SeoToolsCustomEntityDefinition
    : ICustomEntityDefinition<SeoToolsDataModel>
    , ISortedCustomEntityDefinition
{
    ...
    /// </summary>
    public const string DefinitionCode = "SEOTLA";
    ...
    /// </summary>
    public string Name => "Seo Tools";

    /// <summary>
    /// Plural name of the entity.
    /// </summary>
    public string NamePlural => "Seo Tools";

    /// <summary>
    /// A short description that shows up as a tooltip for the admin .
    /// module.
    /// </summary>
    public string Description => "Seo Tools to help ranking the website";
