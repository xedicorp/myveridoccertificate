angular
    .module('cms.seotools', ['ngRoute', 'cms.shared'])
    .constant('_', window._)
    .constant('seotools.modulePath', '/Admin/Modules/SeoTools/Js/');
angular.module('cms.seotools').config([
    '$routeProvider',
...
function (
    ...
    routingUtilities.registerCrudRoutes($routeProvider, modulePath, 'SeoTools');
}]);
...
function (
    ...
    function init() {
       ...
       // vm.gridLoadState = new LoadState();
        vm.canCreate = permissionValidationService.canCreate('XSEOTL');
