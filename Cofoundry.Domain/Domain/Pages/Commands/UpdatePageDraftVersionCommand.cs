...
public class UpdatePageDraftVersionCommand : IPatchableByIdCommand, ILoggableCommand
{
    ...
    [Display(Name = "Meta title", Description = "Ideally 25-250 characters. The Google <a href=\"http://en.wikipedia.org/wiki/Search_engine_results_page\" target=\"_blank\">SERP</a> shows only the first 150 characters")]
    [StringLength(300)]
    public string MetaTitle { get; set; }

    [Display(Name = "Meta keywords", Description = "Ideally 25-250 characters. The Google <a href=\"http://en.wikipedia.org/wiki/Search_engine_results_page\" target=\"_blank\">SERP</a> shows only the first 150 characters")]
    [StringLength(300)]
