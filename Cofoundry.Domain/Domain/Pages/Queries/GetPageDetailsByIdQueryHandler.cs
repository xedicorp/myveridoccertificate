    ...
    , IPermissionRestrictedQueryHandler<GetPageDetailsByIdQuery, PageDetails>
{
    ...
    public async Task<PageDetails> ExecuteAsync(GetPageDetailsByIdQuery query, IExecutionContext executionContext)
    {
        ...
        var headerfooterSetting= await GetHeaderFooterSetting();
        return Map(dbPageVersion, regions, pageRoute, headerfooterSetting);
    }
        ...
        )
    {
        ...
        page.HeaderFooterDetail = new Domain.HeaderFooter.Models.HeaderFooterDetails
        {
            Address = headerFooterSetting.Address,
            Email = headerFooterSetting.Email,
            Phone = headerFooterSetting.Phone
        };
    ...
    private async Task<HeaderFooterSetting> GetHeaderFooterSetting()
    {
        return await _dbContext.HeaderFooterSettings.FirstOrDefaultAsync();
