...
public class AdminApiRouteRegistration : IOrderedRouteRegistration
{
    ...
    public void RegisterRoutes(IEndpointRouteBuilder routeBuilder)
    {
        ...
        MapHeaderFooterApiRoutes(routeBuilder);
        MapSeoToolsApiRoutes(routeBuilder);
    ...
    private static void MapHeaderFooterApiRoutes(IEndpointRouteBuilder routeBuilder)
    {
        routeBuilder
            .ForAdminApiController<HeaderFooterApiController>("headerfooter")
             .MapGet()
            .MapPost() ;
    }
    private static void MapSeoToolsApiRoutes(IEndpointRouteBuilder routeBuilder)
    {
        routeBuilder
            .ForAdminApiController<SeoToolsApiController>("seotools")
             .MapGet()
            .MapPost();
    }
