...
public class AdminRouteLibrary : IAdminRouteLibrary
{
    public AdminRouteLibrary(AdminSettings adminSettings)
    {
        ...
        HeaderFooter = new HeaderFooterRouteLibrary(adminSettings);
        SeoTools = new SeoToolsRouteLibrary(adminSettings);
    }
    ...
    public HeaderFooterRouteLibrary HeaderFooter { get; private set; }
    public SeoToolsRouteLibrary SeoTools { get; private set; }
}
